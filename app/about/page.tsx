  ...
  return (
    <>
      ...
      <header className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1">
            ...
            <div className="flex items-center gap-6">
              <Button
                size="lg"
                className="shadow-lg shadow-primary/20 hover:-translate-y-1"
              >
                Discover Our Ethos
              </Button>
            </div>
      ...
      <section className="py-24 bg-white/30 dark:bg-black/10 backdrop-blur-sm transition-colors">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl leading-loose text-brown/70 dark:text-white/70 italic">
            ...
            name is a promise—to be the 'Ownest' partner in your journey towards
            financial sovereignty, treating your capital as if it were our own."
          </p>
