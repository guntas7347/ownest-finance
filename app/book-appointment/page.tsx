...
export default function BookAppointment() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-12 bg-background-light dark:bg-background-dark min-h-screen text-brown transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card variant="glass" className="p-6">
              <div className="flex items-center justify-between mb-8">
                ...
                <h3 className="font-bold text-lg text-brown">October 2024</h3>
                <button className="p-2 hover:bg-primary/10 rounded-lg transition-colors text-brown">
