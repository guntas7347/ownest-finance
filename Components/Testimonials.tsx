...
export default function Testimonials() {
  ...
  return (
    <section className="py-16 bg-brown/5 dark:bg-black/20 transition-colors">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-brown/50 dark:text-white/50 uppercase font-bold tracking-wider">
                    {item.role}
                  </p>
                </div>
              </div>
