  ...
  return (
    <section className="py-16 max-w-4xl mx-auto px-6">
      <div className="text-center mb-16 space-y-4">
        <h2 className="text-4xl font-extrabold text-brown">Clear Answers.</h2>
        ...
        {faqs.map((faq, index) => (
          <div key={index} className="group">
            <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-brown/5 dark:border-white/5 hover:border-primary/20 transition-all cursor-pointer">
              ...
              <div className="mt-4 text-sm text-brown/70 dark:text-white/70 leading-relaxed overflow-hidden max-h-0 group-hover:max-h-40 transition-all duration-300">
                {faq.answer}
              </div>
            </div>
          </div>
